...
# setting the volume origin to the volume center
# image_center = image.GetBufferedRegion().GetSize()
# image_center[0] //= 2
# image_center[1] //= 2
# image_center[2] //= 2
# image_center_mm = image.TransformIndexToPhysicalPoint(image_center)
# image.SetOrigin(image_center_mm)
# image.GetOrigin()
...
center = [cx + im_origin[0], cy + im_origin[1], cz + im_origin[2]]
...
spacing = [im_resolution[0], im_resolution[2], 1.0] # [0.935574, 0.7, 1.0]
...
# x-axis: DRR image origin same as focal point origin
